...
2. Input the index of the element that Anna did not eat
3. Input the array
4. Input the amount Brian charged Anna
5. Calculate the total bill
6. Calculate the split amount
7. Check who paid more or if the amount is equal
8. If the amount is equal, print 'Bon Appetit"
9. Else print the amount that needs to be paid to balance the spilt 
